...
money_supp %>% 
  ...
  labs(
    y = 'Percentage Change in Money Supply MOM' , 
    x= '' , 
    subtitle = '' ,
    title = ''
  ...
  geom_text(
    data = data.frame(x = as.POSIXct(as.Date(c("2019-04-30"))), y = 0.12, label = "COVID TIMES"),
  ...
  geom_curve(
    data = data.frame(x =as.POSIXct(as.Date(c("2019-04-30"))) , y = 0.7, xend = as.POSIXct(as.Date(c("2020-04-30"))), yend = 0.35),
